!function e(n, t, r) {
        ...
        t.default = class {
            ...
            _addFavicons() {
                const e = "".concat(this.paths.game, "/distribution/favicon/"),
                    n = (new DOMParser).parseFromString(o.default.getHTML({
                        path: e,
                        game: s
                    }), "text/html").head.children;
                ...
                t.forEach(e => {
                    ...
                    Object.keys(s).forEach((e, t, o) => {
                        s[e].forEach((t, o, s) => {
                            ...
                            r++, this.loadScript({
                                src: "".concat(this.paths[e]).concat(t),
                                type: "module",
                                onLoad: () => {
                                    r--, !r && n()
                                }
    ...
    17: [function (e, n, t) {
        ...
        n.exports = function (e, n, t, u, f, v, m) {
            ...
            var x, w, j, _ = function (e) {
                ...
                }, k = n + " Iterator", S = !1, E = e.prototype, O = E[h] || E["@@iterator"] || f && E[f],
                T = !b && O || _(f), L = "Array" == n && E.entries || O;
            if (L && (x = s(L.call(new e)), g !== Object.prototype && x.next && (p || s(x) === g || (i ? i(x, g) : "function" != typeof x[h] && l(x, h, y)), a(x, k, !0, !0), p && (d[k] = y))), "values" == f && O && "values" !== O.name && (S = !0, T = function () {
                ...
                keys: v ? T : _("keys"),
                entries: _("entries")
            }, m) for (j in w) (b || S || !(j in E)) && c(E, j, w[j]); else r({
                target: n,
                proto: !0,
                forced: b || S
            }, w);
    ...
    19: [function (e, n, t) {
        var r = e("../internals/global"), o = e("../internals/is-object"), s = r.document,
    ...
    30: [function (e, n, t) {
        var r = e("../internals/descriptors"), o = e("../internals/fails"),
    ...
    33: [function (e, n, t) {
        var r, o, s, i = e("../internals/native-weak-map"), a = e("../internals/global"),
            l = e("../internals/is-object"), c = e("../internals/create-non-enumerable-property"),
            u = e("../internals/has"), p = e("../internals/shared-key"), d = e("../internals/hidden-keys"),
            f = a.WeakMap;
        if (i) {
    ...
    39: [function (e, n, t) {
        "use strict";
        var r, o, s, i = e("../internals/object-get-prototype-of"),
            a = e("../internals/create-non-enumerable-property"), l = e("../internals/has"),
            c = e("../internals/well-known-symbol"), u = e("../internals/is-pure"), p = c("iterator"), d = !1;
    ...
    57: [function (e, n, t) {
        var r = e("../internals/global"), o = e("../internals/create-non-enumerable-property"),
            s = e("../internals/has"), i = e("../internals/set-global"), a = e("../internals/inspect-source"),
            l = e("../internals/internal-state"), c = l.get, u = l.enforce, p = String(String).split("String");
    ...
    79: [function (e, n, t) {
        ...
        var r = e("../internals/to-indexed-object"), o = e("../internals/add-to-unscopables"),
            s = e("../internals/iterators"), i = e("../internals/internal-state"),
            a = e("../internals/define-iterator"), l = i.set, c = i.getterFor("Array Iterator");
    ...
    84: [function (e, n, t) {
        ...
        var r = e("../internals/fix-regexp-well-known-symbol-logic"), o = e("../internals/is-regexp"),
            ...
            c = e("../internals/to-length"), u = e("../internals/regexp-exec-abstract"),
            p = e("../internals/regexp-exec"), d = e("../internals/fails"), f = [].push, g = Math.min,
            b = !d((function () {
    ...
    85: [function (e, n, t) {
        var r = e("../internals/global"), o = e("../internals/dom-iterables"), s = e("../modules/es.array.iterator"),
            i = e("../internals/create-non-enumerable-property"), a = e("../internals/well-known-symbol"),
            l = a("iterator"), c = a("toStringTag"), u = s.values;
        for (var p in o) {
